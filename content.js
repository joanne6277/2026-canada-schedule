...
var CONTENT = {
  ...
  checklists: [
...

    {
      ...
      nav: "極光保暖",
      title: "黃刀鎮看極光",
      hint: "極光團一晚要在戶外 4 小時以上，中途沒辦法回室內換衣服。下方「衣服」清單裡的發熱衣褲、厚羊毛襪、毛帽、手套、脖圍都要全部穿戴上；這裡只列黃刀鎮額外要準備的東西。",
      items: [
        { text: "暖暖包", note: "貼式和手握式都帶，韓國的軍用暖暖包超級暖，轉機時可以去看看", must: true },
...

    {
      ...
      title: "衣服（每人）",
      items: [
        { text: "底層發熱衣褲 2 套", note: "黃刀鎮看極光那幾晚每天都要穿", must: true },
        { text: "中層長袖上衣" },
        { text: "長褲", note: "有防風防水佳" },
        { text: "刷毛外套或薄羽絨" },
        { text: "防風防水外套 1 件", note: "連帽佳", must: true },
        { text: "內衣褲、一般襪子" },
        { text: "厚羊毛襪 3 雙", note: "看極光時腳最容易冷，襪子一定要厚", must: true },
        { text: "睡衣" },
        ...
        { text: "脖圍或圍巾", note: "黃刀鎮建議帶能拉高遮住口鼻的脖圍或面罩", must: true },
